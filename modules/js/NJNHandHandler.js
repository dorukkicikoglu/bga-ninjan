    ...
    function (dojo, declare) {
        var HandHandler = declare("bgagame.HandHandler", null, {
            ...
            cardsContainerClicked(event){
                if(this.gameui.gamedatas.gamestate.name != 'selectCard' || this.gameui.isInterfaceLocked())
                    return;
            ...
            updateConfirmedSelection(confirmedCardID){
                if(!confirmedCardID)
