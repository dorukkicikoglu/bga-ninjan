            ...
            cardClicked(card){
                if(this.gameui.gamedatas.gamestate.name == 'takePile'){ //pre-selection
                    ...
                    if(!preSelectionEnabled){
                        this.gameui.confirmationDialog(_("This will let you select next round's cards in advance"), () => { 
                            this.gameui.prefHandler.setPref('card_preselection', 1);
                            this.cardClicked(card);
                        });
                        dojo.query('.standard_popin .standard_popin_title')[0].innerHTML = _('Enable card pre-selection?');
                        return;
                    }
                }
