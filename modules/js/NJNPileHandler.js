        ...
        var PileHandler = declare("bgagame.PileHandler", null, {
            ...
            displayPiles(){
                for(pileIndex in this.pilesData){
                    var pileContainer = dojo.place(this.gameui.format_block('jstpl_pile_container', {pileIndex: pileIndex}), this.pilesContainer);
            ...
            fillPileQueue(){
                ...
                for(cardIndex in this.pileQueueData){
                    ...
                    var cardContainer = dojo.place(this.gameui.format_block('jstpl_queue_card', {playerName: this.gameui.divColoredPlayer(cardData.owner_id)}), wrapper);
                    if(cardIndex == 1)
            ...
            showPossiblePiles(possiblePiles){
                ...
                for(pileIndex of possiblePiles.pile_indeces)
